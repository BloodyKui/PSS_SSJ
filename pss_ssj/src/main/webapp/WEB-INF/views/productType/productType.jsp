...
<body>
	...
	<s:form action="productType" id="domainForm">
		<s:debug></s:debug>
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
					...
					<!-- 新增数据按钮 -->
					<a href="/productType_input.action" class="btn"> <i
													...
													<td>
														<div
															...
															<!-- 编辑时为了保证编辑过后留在当前页，需要传递的参数比较多
																 ...
																 的参数
															 -->
															<%-- <a href="/productType_input.action?id=${id}&baseQuery.currentPage=${baseQuery.currentPage}" --%>
															<!-- class="btn btn-xs btn-info"> <i -->
															<!-- class="icon-edit bigger-120"></i> -->
															<!-- </a>  -->
															<button type="button"
																onclick="transferParams('/productType_input.action', '${id}')"
																class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</button>
															<button type="button"
																onclick="deleteOne('/productType_delete.action', ${id},this)"
