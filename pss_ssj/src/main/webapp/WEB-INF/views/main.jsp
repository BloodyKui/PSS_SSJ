				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${LOGINUSER_IN_SESSION.headImage}" alt="${LOGINUSER_IN_SESSION.username}'s Photo" /> <span
							class="user-info"> <small>欢迎光临,</small>
							<%-- 从session中拿到当前登录用户对象 --%>
							${LOGINUSER_IN_SESSION.username}
						...
						<ul
							...
							<li><a onclick="javascript:if(confirm('是否要退出')){window.location.href='login_logout.action'}"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<%-- 遍历父菜单 --%>
					<s:iterator value="#menus_parent">
					<li><a href="#" class="dropdown-toggle"> <i
							class="icon-desktop"></i> <span class="menu-text"> ${name} </span>
			...
			<!-- iframe部分 -->
			<iframe src="/main_right.action" id="rightIframe" frameborder="0"
				scrolling="yes" marginheight="0" marginwidth="0" name="main"
			...
			<script type="text/javascript">
				function autoHeight() {
					...
					if (iframe.Document) {//ie自有属性
						...
						iframe.width = screen.width - $("#sidebar").width()
								- 20;
					}
				}
			</script>
