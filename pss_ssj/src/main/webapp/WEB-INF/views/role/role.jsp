...
<body>
	...
	<s:form action="role" id="domainForm">
		<s:debug></s:debug>
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
					...
					<!-- 新增数据按钮 -->
					<a href="/role_input.action" class="btn"> <i
						class="icon-pencil align-top bigger-125"></i> 添加角色
					</a>
				</div>
				<!-- /.page-header -->
											...
											<s:iterator value="pageList.results">
												...
												<tr
													...
													<td>
														...
														<%-- 方式二 
															因为是去调用每一个permission的toString,
															所以可以设置permission的toString达到打印的目的
														 --%>
														 
														 <%-- 方式三 --%>
														 <s:property value="permissions.{name}"/>
													</td>
													...
													<td>
														<div
															...
															<!-- 编辑时为了保证编辑过后留在当前页，需要传递的参数比较多
																 ...
																 的参数
															 -->
															<%-- <a href="/role_input.action?id=${id}&baseQuery.currentPage=${baseQuery.currentPage}" --%>
															<!-- class="btn btn-xs btn-info"> <i -->
															<!-- class="icon-edit bigger-120"></i> -->
															<!-- </a>  -->
															<button type="button"
																onclick="transferParams('/role_input.action', '${id}')"
																class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</button>
															<button type="button"
																onclick="deleteOne('/role_delete.action', ${id},this)"
