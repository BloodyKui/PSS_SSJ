		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<s:form class="form-horizontal" action="role_save" id="domainForm">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-2"> 权&nbsp;限 </label>

							<div class="col-sm-9">
								<s:checkboxlist name="permissions.id" list="#allPermissions" value="permissions.{id}"
