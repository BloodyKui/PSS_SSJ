		...
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
					...
					<!-- 新增数据按钮 -->
					<a href="/product_input.action" class="btn"> <i
						class="icon-pencil align-top bigger-125"></i> 新建
					</a>
				</div>
				<!-- /.page-header -->
										...
										<tbody id="eachPage">
											<s:iterator value="pageList.results">
												...
												<tr
													...
													<td>
														<%-- <img alt="缩略图" src="${smallPic}" /> --%>
														<s:if test="smallPic!=null">
															<div class="row-fluid">
																<ul class="ace-thumbnails">
																	<li><a href="${pic}" data-rel="colorbox"> <img
																			alt="150x150" src="${smallPic}" />
																	</a></li>
																</ul>
															</div>
														</s:if>
													...
													<td>
														<div
															...
															<!-- </a>  -->
															<button type="button"
																onclick="transferParams('/product_input.action', '${id}')"
																class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</button>
															<button type="button"
																onclick="deleteOne('/product_delete.action', ${id},this)"
