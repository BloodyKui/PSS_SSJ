...
<title>systemDictionaryDetail</title>
</head>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<s:form class="form-horizontal" action="systemDictionaryDetail_save" id="domainForm">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1"> systemDictionaryDetail </label>
