...
<script type="text/javascript" src="/js/model/${lowerEntity}.js"></script>
<title>${lowerEntity}</title>
</head>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<s:form class="form-horizontal" action="${lowerEntity}_save" id="domainForm">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1"> ${lowerEntity} </label>
